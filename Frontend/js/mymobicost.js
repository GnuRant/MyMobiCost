...
function magic(){
	...
	easter_egg.code = function() {
		...
		$("body").append('<iframe width="100%" height="100%" src="//www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1" frameborder="0" allowfullscreen></iframe>')
		$("#container-confronto").remove();
	}
	easter_egg.load();
}